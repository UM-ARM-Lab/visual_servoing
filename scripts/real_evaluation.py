...
result = pkl.load(open("test-results/20221018-184200/result.pkl", "rb"))
...
tool_target_error_fig, (gt_tool_target_error_ax, aruco_tool_target_error_ax) = plt.subplots(2, 1)
gt_tool_target_error_ax.set_xlabel("iteration")
gt_tool_target_error_ax.set_ylabel("error (m)")
gt_tool_target_error_ax.plot(gt_tool_target_error)
